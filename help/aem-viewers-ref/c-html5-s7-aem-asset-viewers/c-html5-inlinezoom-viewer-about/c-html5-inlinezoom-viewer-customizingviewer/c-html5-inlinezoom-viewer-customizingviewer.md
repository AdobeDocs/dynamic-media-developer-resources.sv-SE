...
För att det ska gå lättare att skapa responsiv CSS-kod stöder visningsprogrammet CSS-markörer som har särskilda CSS-klasser dynamiskt tilldelade till visningsprogrammets behållarelement på den översta nivån. Tilldelningarna baseras på visningsprogrammets storlek vid körning och den indatatyp som används på den aktuella enheten.
...
Att använda CSS-markörer är det mest flexibla sättet att skapa responsiv CSS. Det gör att målstorleken inte bara kan användas för skärmstorleken på enheten utan även för den faktiska visningsstorleken, vilket kan vara användbart för responsiva designade webbsideslayouter.
