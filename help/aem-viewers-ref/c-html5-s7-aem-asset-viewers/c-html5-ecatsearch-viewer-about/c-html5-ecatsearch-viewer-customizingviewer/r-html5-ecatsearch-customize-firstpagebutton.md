...
Om du markerar eller trycker på den här knappen flyttas användaren till den första sidan i katalogen. Den här knappen visas i huvudkontrollfältet på stationära datorer och surfplattor. På mobiltelefoner läggs den till i ett sekundärt kontrollfält. Du kan ändra storlek, skal och position för knappen med hjälp av CSS.
...
Exempel - Om du vill ställa in en första sidknapp som är 28 x 28 pixlar och placerad 4 pixlar från nederkanten och 220 pixlar från den vänstra kanten av huvudkontrollfältet. Slutligen visas olika bilder för de fyra olika knapplägena.
