...
<table id="table_9E7BB12BF371419F88DD4D24EF04632C"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Kommandosträngen Bildrutevisning som används på alla miniatyrbilder. Om det anges i URL:en, alla förekomster av <span class="codeph"> &amp;</span> och <span class="codeph"> =</span> måste vara HTTP-kodad som <span class="codeph"> %26</span> och <span class="codeph"> %3D</span>, respektive. </p> </td> 
  </tr> 
 </tbody> 
</table>
