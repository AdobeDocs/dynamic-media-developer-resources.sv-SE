...
Anger en ny resurs. Du kan anropa den här parametern när som helst, antingen före eller efter [!DNL `init()`]. Om det anropas efter [!DNL `init()`]byts resursen ut vid körning.
