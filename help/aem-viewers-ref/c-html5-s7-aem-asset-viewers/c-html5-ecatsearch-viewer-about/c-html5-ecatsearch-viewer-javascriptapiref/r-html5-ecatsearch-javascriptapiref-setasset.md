...
Anger en ny resurs. Du kan anropa den här parametern när som helst, antingen före eller efter [!DNL `init()`]. Om den anropas efter [!DNL `init()`]byter visningsprogrammet ut resursen vid körning.
