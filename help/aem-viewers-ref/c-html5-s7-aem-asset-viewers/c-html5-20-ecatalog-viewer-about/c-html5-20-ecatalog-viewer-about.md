...
Visningsprogrammet är fullt åtkomligt via tangentbordet enligt beskrivningen i [Tangentbordstillgänglighet och -navigering](../../c-keyboard-accessibility.md#topic-f5650e9493404e55a3627c8d1366b861).
...
Vi rekommenderar att du använder en körklar HTML-sida för popup-åtgärder. I det här fallet kallas det [!DNL eCatalogViewer.html] och finns i undermappen [!DNL html5/] i din standarddistribution av IS-Viewer:
...
1. Lägga till JavaScript-filen för visningsprogrammet på webbsidan.
   ...
   Om du vill skapa ett visningsprogram måste du lägga till en script-tagg i HTML-huvudet. Innan du kan använda visningsprogrammets API måste du ta med [!DNL eCatalogViewer.js]. Filen [!DNL eCatalogViewer.js] finns under undermappen [!DNL html5/js/] i din standarddistribution av IS-Viewer:
