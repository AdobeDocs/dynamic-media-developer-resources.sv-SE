...
Video Viewer representerar en JavaScript-huvudfil och en uppsättning hjälpfiler - en enda JavaScript-komponent med alla SDK-komponenter för visningsprogrammet som används av det här visningsprogrammet, resurser och CSS-kod som hämtats av visningsprogrammet under körning.
...
Vi rekommenderar att du använder en HTML-sida som inte finns i kartongen för popup-åtgärder. Den kallas [!DNL VideoViewer.html] och finns under undermappen [!DNL html5/] i din standarddistribution av IS-Viewer:
...
1. Lägga till visningsprogrammets JavaScript-fil på webbsidan.
   ...
   Om du vill skapa ett visningsprogram måste du lägga till en script-tagg i huvudet HTML. Innan du kan använda visningsprogrammets API måste du ta med [!DNL FlyoutViewer.js]. Filen [!DNL FlyoutViewer.js] finns under undermappen [!DNL html5/js/] i din standarddistribution av IS-Viewer:
