...
I kodexemplet ovan anges volymnivån till `0` på `mutableVolume` komponenten. Sedan inaktiveras samma komponent så att den inte kan användas av slutanvändaren.
