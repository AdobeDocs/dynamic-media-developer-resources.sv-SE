...
>[!NOTE]
>
>Den här knappen har stöd för både attributväljaren, som du kan använda för att tillämpa olika skal på olika knapplägen. `state` Motsvarar i synnerhet standardläget för videokapitelmarkör och `selected='default'` `selected='over'` används när videokapitelmarkören aktiveras av en muspekare eller en pekgest.
