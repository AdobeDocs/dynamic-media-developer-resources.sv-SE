...
Exempel - Om du vill ställa in ett dialoghuvud med utfyllnad, ikonen 24 x 14 pixlar, fetstil 16 punkters rubrik. Slutligen en stängningsknapp på 28 x 28 pixlar, placerad två pixlar uppifrån och två pixlar från höger om dialogrutans behållare:
...
Verktygstips för dialogruteetiketter kan lokaliseras. Se [Lokalisering av användargränssnittselement](../../../c-html5-s7-aem-asset-viewers/c-html5-video-reference/r-html5-video-viewer-20-localization.md#concept-1d5ca2d8480f4064a51eddba13940aad) för mer information.
...
Exempel - Så här ställer du in inbäddad kod så att den används `break-word` automatisk radbrytning:
