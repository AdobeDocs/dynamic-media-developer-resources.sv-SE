...
* Om du publicerar en Dynamic Media-video med inbäddad kod lägger du till `VideoPlayer.ssl` till listan över andra konfigurationsparametrar för visningsprogrammet i kodfragmentet för inbäddning. Om du till exempel vill tvinga fram HTTPS-video lägger du till `&VideoPlayer.ssl=on` som i följande exempel:
