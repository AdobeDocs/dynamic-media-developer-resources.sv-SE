...
Rotationsindikatorn har stöd för attributväljaren `state` som är inställd på `spin_1D` om det finns en endimensionell snurra och på `spin_2D` om det finns en flerdimensionell snurra.
