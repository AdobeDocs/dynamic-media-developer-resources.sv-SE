...
Om du till exempel tänker lyssna på `StatusEvent.NOTF_VIEW_READY` händelsen och visningsprogrammet hanteras av AEM, är den fullständigt kvalificerade händelsetypen `s7viewers.s7sdk.event.StatusEvent.NOTF_VIEW_READY`och händelseavlyssnarkoden ser ut ungefär så här:
