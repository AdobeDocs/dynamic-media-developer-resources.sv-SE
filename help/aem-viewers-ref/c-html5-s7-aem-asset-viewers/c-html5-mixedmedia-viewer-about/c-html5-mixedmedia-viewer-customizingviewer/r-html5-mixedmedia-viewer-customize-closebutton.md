...
Om du väljer den här knappen stängs webbsidan som innehåller. Den här knappen visas bara om parametern closeButton är inställd på 1. Du kan ändra storlek, skal och position för knappen med hjälp av CSS.
