...
seo-description: Aktiverar och inaktiverar visning av undertexter. Den är inte synlig om bildtextparametern inte har angetts. Du kan använda CSS för att ändra storlek på, skalförändra och placera den här knappen i förhållande till kontrollfältet som innehåller den.
...
>[!NOTE]
>
>Den här knappen har stöd för attributväljaren och de valda attributväljarna, som kan användas för att tillämpa olika skal på olika knapplägen. `state` Speciellt motsvarar `selected='true'` läget när bildtexter är synliga och `selected='false'` används när bildtexter är dolda.
...
Exempel - om du vill ställa in en knapp med en undertextning som är 28 x 28 pixlar, placerad fyra pixlar från överkanten och 68 pixlar från högerkanten av kontrollfältet, och visar en bild för vart och ett av de fyra knapplägena när det är markerat eller inte.
