...
Om behållarelementet inte är en del av webbsideslayouten än (till exempel kan det vara dolt med formatet `display:none`), kommer visningsprogrammet att avbryta initieringsprocessen. Det gör det tills webbsidan återför behållarelementet till layouten. När den här processen utförs återtas visningsprogrammet automatiskt.
