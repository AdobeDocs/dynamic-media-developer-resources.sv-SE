...
## Nya funktioner och förbättringar för 5.15.1 {#section-f55c5ff7f6d0406c8739de4981dd7195}
...
* `RolloverKeyEvent.HREF_ACTIVATED`-händelse har lagts till för att tillåta klientkoden att svara på aktivering av bildscheman i eCatalogViewer och eCatalogSearchViewer.
