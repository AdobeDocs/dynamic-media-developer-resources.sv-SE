...
* Stöd för integrering med Adobe Launch [!DNL Dynamic Media]-visningsprogramtillägget har lagts till.
* Stöd för VR-funktionsläge har lagts till i Oculus Browser för Video360Viewer.
* `RolloverKeyEvent.HREF_ACTIVATED`-händelse har lagts till så att klientkoden kan svara på aktivering av bildscheman i eCatalogViewer och eCatalogSearchViewer.
