...
**VIKTIGT!** Den senaste versionen av Firefox förhindrar nu att plugin-programmet för Adobe Flash körs på webbplatser som standard. Om du har distribuerat den Scene7 videospelare som använder plugin-programmet för Flash på stationära datorer har du följande tre alternativ:
