...
* Tillagd `getComponent` API som tillåter extern åtkomst till visningsprogramkomponenter.
...
* Posterbilden kan ha felet &quot;max size&quot;. I så fall måste användaren öka gränsvärdet för Image Serving Publish.
