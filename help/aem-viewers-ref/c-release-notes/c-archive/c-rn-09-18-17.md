...
* Värdet `native` av `playback` modifieraren är inaktuell; använd det nya värdet `progressive` i stället.

* Stöd för uppspelning av HTTPS-direktuppspelning för [!DNL Dynamic Media] video.
