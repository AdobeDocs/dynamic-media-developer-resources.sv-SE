...
* Värdet `native` på `playback` modifieraren är föråldrat. använder du det nya värdet `progressive` i stället.

* Stöd för uppspelning av HTTPS-direktuppspelning för [!DNL Dynamic Media] video har lagts till.
