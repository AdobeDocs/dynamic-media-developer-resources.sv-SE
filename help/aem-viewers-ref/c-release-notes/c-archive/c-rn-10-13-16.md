...
* Stöd för både mus- och pekrörelser som körs i Chrome-webbläsaren har lagts till. Microsoft Surface-enheter tillhör den här kategorin, men Microsoft Edge fungerar inte med pekrörelser i 5.5-visningsprogram.
...
* Posterbilden kan träffa på en `max size` fel. Du kan behöva öka gränsvärdet för Image Serving Publish.
...
* På iPad- eller Android-enheter kan en svart bildruta visas i stället för en förhandsvisningsbild.
