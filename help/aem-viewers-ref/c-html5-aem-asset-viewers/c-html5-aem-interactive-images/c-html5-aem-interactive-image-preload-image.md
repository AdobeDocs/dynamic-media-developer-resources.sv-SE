...
* När visningsprogrammet har en fast storlek och storleken har definierats med konfigurationsattributet `stagesize` i visningsprogrammets förinställningspost. Du kan också använda CSS-filen för det externa visningsprogrammet för visningsprogrammets behållarelement på den översta nivån.
