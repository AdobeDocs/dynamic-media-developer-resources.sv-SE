...
Förhandsladda bilder fungerar bra för den vanligaste inbäddningsmetoden för visningsprogram, som är responsiv inbäddning med obegränsad höjd. Se rubriken Inbäddning av [responsiv design med obegränsad höjd](../../c-html5-aem-asset-viewers/c-html5-aem-interactive-images/c-html5-aem-interactive-images.md#section-6bb5d3c502544ad18a58eafe12a13435).
...
* När visningsprogrammet har en fast storlek och storleken definieras antingen med hjälp av `stagesize` konfigurationsattributet i visningsprogrammets förinställningspost eller i den externa visningsprogrammets CSS-fil för visningsprogrammets behållarelement på den översta nivån.
...
Du kan behöva inaktivera funktionen för förhandsladda bilder med hjälp av `preloadImage` konfigurationsattributet om du använder visningsprogrammet i något av de åtgärdslägen som anges ovan.

Dessutom används inte förinläsningsbilden, även om den är aktiverad i konfigurationen, om visningsprogrammet är inbäddat i DOM-elementet är dolt med `display:none` CSS-inställningen eller om det är frånkopplat från DOM-trädet.
