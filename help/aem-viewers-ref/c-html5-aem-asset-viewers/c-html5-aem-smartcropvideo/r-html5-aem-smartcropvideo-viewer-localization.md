...
description: Viss information som visas i visningsprogrammet för smart beskärning kan lokaliseras. Innehållet innehåller funktionsbeskrivningar för användargränssnittselement och ett felmeddelande som visas när videon inte kan spelas upp.
...
Viss information som visas i visningsprogrammet för smart beskärning kan lokaliseras. Innehållet innehåller funktionsbeskrivningar för användargränssnittselement och ett felmeddelande som visas när videon inte kan spelas upp.
...
<table id="table_58C40353B7244335872350C98DF2CFB3"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Volymreglagets knobetikett som visas med attributet <span class="codeph"> aria-valuetext </span> för ARIA. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> Bädda inShare.TOOLTIP-ÅTGÄRD </span> </p> </td> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Verktygstips för delningsknappen i Facebook. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> TwitterShare.TOOLTIP </span> </p> </td> 
   <td colname="col2"> <p>Verktygstips för knappen för att dela Twitter. </p> </td> 
  </tr> 
  <tr> 
