...
När du arbetar med SDK API:er är det viktigt att du använder rätt fullständigt kvalificerade SDK-namnutrymme enligt beskrivningen i [visningsprogrammets SDK-namnområde]
