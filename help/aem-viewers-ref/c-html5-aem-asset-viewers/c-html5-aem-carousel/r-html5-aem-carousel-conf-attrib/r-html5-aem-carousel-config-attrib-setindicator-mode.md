...
<table id="table_0BEA0B5FFDF64E5594B534B2A87A6D88"> 
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Konfigurerar återgivningsformatet för den angivna indikatorn. </p> <p>När den är inställd på <span class="codeph"> prickad</span> återges identiska indikatorer för alla sidor. </p> <p>Om det anges som <span class="codeph"> numeriskt</span> placeras ett 1-baserat sidnummer inuti varje indikatorelement. </p> <p>Det <span class="codeph"> numeriska</span> driftsläget stöds inte på enheter som kan hantera pekrörelser. I stället använder komponenten <span class="codeph"> prickade</span> på sådana enheter. </p> </td> 
  </tr> 
 </tbody> 
</table>
