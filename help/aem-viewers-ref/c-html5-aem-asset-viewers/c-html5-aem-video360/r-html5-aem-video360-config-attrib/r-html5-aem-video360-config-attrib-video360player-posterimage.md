 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p> Funktionsändringstecken som styr förhandsvisningsbildens utseende. Om det anges i URL:en, HTTP-kodar du följande: </p> <p> 
     ...
     </ul> </p> <p> Modifieraren fungerar för videoinnehåll på Dynamic Media Classic eller Adobe Experience Manager, Dynamic Media. </p> <p>Om du vill förhindra att standardförhandsvisningsbilden visas anger du <span class="codeph"> ingen</span> som värde för förhandsvisningsbilden. </p> </td> 
  </tr> 
 </tbody> 
</table>
