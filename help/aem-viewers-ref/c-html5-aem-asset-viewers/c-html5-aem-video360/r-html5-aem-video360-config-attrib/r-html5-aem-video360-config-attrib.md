...
Alla konfigurationskommandon kan anges i URL eller med `setParam()`, eller `setParams()`, eller båda, API-metoder. Alla konfigurationsattribut kan också anges i konfigurationsposten på serversidan.
