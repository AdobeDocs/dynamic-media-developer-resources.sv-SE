...
>[!NOTE]
>
>Den här knappen har stöd för både attributväljarna `state`, `selected`och `replay` , som kan användas för att tillämpa olika skal på olika knapplägen. motsvarar `selected='true'` i synnerhet&quot;play&quot;-läget och `selected='false'` motsvarar&quot;pause&quot;-läget,
>
