...
Verktygstipset för videospolning kan lokaliseras. Mer information finns i [Lokalisering av användargränssnittselement](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-viewer-localization.md#concept-cbfc39344c494eb7b9f6a272cff0cc74) .
...
När videofiltrering är aktiverat med `navigation` parametern visas kapitelplaceringar som markörer ovanpå videonavigeringsspåret.
...
>[!NOTE]
>
>Den här knappen har stöd för attributväljaren, som du kan använda för att använda olika skal på olika knapplägen. `state` Motsvarar i synnerhet standardläget för videokapitelmarkör och `selected='default'` `selected='over'` används när videokapitelmarkören aktiveras av en muspekare eller en pekgest.
...
**Exempel** - Om du vill ställa in en videokapitelrubrik som använder ett vitt, fetstilt teckensnitt på tio pixlar.
...
<table id="table_BC6AFB57D9404A84A3AE657448C0EB06"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p> Bredd på kantkoppling. </p> <p>Definieras som <span class="codeph"> &lt;width&gt; &lt;width&gt; 0 </span> så att samma bredd definieras endast för den övre och vågräta kantlinjen och den nedre kantlinjebredden är <span class="codeph"> 0 </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> marginal </span> </p> </td> 
   <td colname="col2"> <p> Definierar endast en negativ nedre marginal. Den ska ha samma värde som för <span class="codeph"> border-width </span>. </p> </td> 
  </tr> 
 </tbody> 
</table>

**Exempel** - Så här ställer du in en grå, sex pixlars kilkopplingsportar:
