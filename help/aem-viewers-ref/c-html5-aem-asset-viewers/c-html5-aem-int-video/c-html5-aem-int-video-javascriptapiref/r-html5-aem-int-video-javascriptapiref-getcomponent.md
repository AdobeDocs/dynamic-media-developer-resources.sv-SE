...
När du arbetar med SDK API:er är det viktigt att du använder ett korrekt, fullständigt kvalificerat SDK-namnutrymme enligt beskrivningen i [visningsprogrammets SDK-namnområde](../../../c-html5-aem-asset-viewers/c-html5-aem-int-video/c-html5-aem-int-video-html5-viewer-sdk-namespace.md#concept-4ee8657c7d67421f8e7880130a246621).

Mer information om en viss komponent finns i dokumentationen för *visningsprogrammets SDK API*.
