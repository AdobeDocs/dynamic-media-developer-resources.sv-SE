...
description: I den senaste releaseversionen beskrivs de senaste funktionerna, förbättringarna och fixarna för Adobe Scene7 Publishing System 6.5, som ingår i Adobe Experience Manager-lösningen i Adobe Experience Cloud.
...
Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.5-delen av Adobe Experience Cloud.
...
* Lagt till tre nya HTML5-visningsprogram: MixedMedia_HTML5, FlyoutZoom_HTML5 och Mobile_Spin_HTML5 (har stöd för snurra på både en- och fleraxeln).
<!-- 
...
* Omfattande **[!UICONTROL Embed Code]** förbättringar har gjorts för att förenkla distributionen av visningsprogram på dina webbsidor. Bland förbättringarna finns följande:
   ...
   * Anpassad reservlösning för enheter som inte har Flash-stöd.
...
* Dynamiska banderoller har förbättrat stöd för HTML5, inklusive korskompilering mellan ActionScript och JavaScript
* Förhandsgranskning av [!DNL Dynamic Banners] med ett klick är nu tillgänglig i Firefox
* **[!UICONTROL Web-To-Print]** tillåter nu att hyperlänkar skapas dynamiskt i PDF-utdata
...
* Stöd för videokodning för OGG Theora för progressiv leverans av HTML5-video.
