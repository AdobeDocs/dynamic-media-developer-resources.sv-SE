...
Den senaste versionsinformationen för Adobe Dynamic Media Classic-delen av [!DNL Adobe Experience Manager]-lösningen i [!DNL Adobe Experience Cloud].
...
Fullständig dokumentation finns i [http://help.adobe.com/en_US/scene7/using/index.html](http://help.adobe.com/en_US/scene7/using/index.html)
...
* HTML5-video
   ...
   * Videoklipp kräver en företagsregeluppsättning om det är en extern server (inte en Dynamic Media-server) som är värd för HTML-sidan. Kontakta supporten för Adobe om du behöver hjälp.
