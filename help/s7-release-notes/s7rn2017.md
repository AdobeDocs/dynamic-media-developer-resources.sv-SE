...
# [!DNL Dynamic Media] Versionsinformation{#dynamic-media-release-notes}
...
## [!DNL Dynamic Media] Versionsinformation {#topic-1f5af440670a42f3bbb662eb86a196c6}
...
* HTML5-video
   ...
   * Videoklipp kräver en företagsregeluppsättning om värdtjänsten för HTML-sidan hanteras från en extern server (inte en [!DNL Dynamic Media] server). Kontakta supporten för Adobe om du behöver hjälp.
