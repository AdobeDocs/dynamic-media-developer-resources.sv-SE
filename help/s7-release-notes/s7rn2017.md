...
description: '"Den senaste versionsinformationen för Adobe Dynamic Media Classic, som ingår i Adobe Experience Manager-lösningen i Adobe Experience Cloud."'
...
Den senaste versionsinformationen för Adobe Dynamic Media Classic som en del av [!DNL Adobe Experience Manager] lösningen i [!DNL Adobe Experience Cloud].
...
Fullständig dokumentation finns i  [https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro](https://experienceleague.adobe.com/docs/dynamic-media-classic/using/intro/introduction.html#intro)
...
* Lagt till möjlighet att ange både vänster och höger sida med `initialframe` i stående läge på mobila enheter i eCatalog-visningsprogrammet.
