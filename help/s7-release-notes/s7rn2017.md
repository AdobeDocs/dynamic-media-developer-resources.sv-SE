...
* HTML5-video
   ...
   * Videobeskrivningar kräver en företagsregeluppsättning om HTML-sidan hanteras från en extern server (inte en Dynamic Media-server). Kontakta Adobes support om du behöver hjälp.
