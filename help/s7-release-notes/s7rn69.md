...
* [Webb-till-tryck](s7rn69.md#section-17c5591d279a48d3b0aea085a19d6321)
...
* **SSO-kapacitet (Single Sign-On)** - Nu kan du starta Scene7 från Adobe Experience Cloud utan problem och logga in på Scene7 med din Adobe ID.
...
* Stöd för återgång till orienteringsspecifikt `MediaSetDesc` objekt.
...
* Stöd för att styra uppskalning av bilder med `zoomfactor` modifierare till HTML5-visningsprogram för utfällbar bild.
...
* Internet Explorer 9 och Internet Explorer 10: Visningsprogrammet för eCatalog bryts när bildschemat har aktiverats med JavaScript-mall.
