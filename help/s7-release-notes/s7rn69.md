...
* **SSO-kapacitet (Single Sign-On)** - Nu kan du starta Scene7 från Adobe Marketing Cloud och använda ditt Adobe ID för att logga in på Scene7.

   Om du vill ha SSO-konfiguration så att du kan använda den med Scene7 kontaktar du Adobes tekniska support. Ha följande information klar så att era Marketing Cloud- och Scene7-konton kan länkas samman: ditt företagsnamn för Adobe Marketing Cloud, ditt Scene7-företagsnamn, och din geografiska region.

## Bildbehandling {#section-98a61ea9a09940639f357f36969d6e55}

* **Bättre stöd** för responsiva bilder - Optimera kvaliteten ytterligare för responsiva bildupplevelser genom att definiera olika förinställningar eller modifieringar för varje brytpunkt. Se [Använda responsivt statiskt bildbibliotek](https://marketing.adobe.com/resources/help/en_US/s7/is_ir_api/is_api/c_about_responsive_static_image_library.html).

## Video {#section-69101b28504543a7ae8a9346d381f913}

* En ny, körklar kodningsförinställning för Adaptiv video som nu fungerar med alla proportioner för att skapa videor som ska skickas till mobiler, surfplattor och datorer. Överförda källvideor som är kodade med den här nya förinställningen har en fast höjd medan bredden automatiskt skalas för att bevara videons proportioner. Se [Videoförinställningar för kodning av videofiler](http://help.adobe.com/en_US/scene7/using/WSE86ACF2B-BD50-4c48-A1D7-9CD4405B62D0.html) och [Arbeta med förinställningar](http://help.adobe.com/en_US/scene7/using/WS56d35d2f221c8d0e1b2f57f5122e27fd0ce-8000.html)för videokodning.
* Förbättrad elastisk skalbarhet och prestanda med kodning.
* Videobildtexter finns nu i färdiga `Universal_HTML5_MixedMedia_dark` och `Universal_HTML5_MixedMedia_light` färdiga visningsprogram. Se [Lägga till bildtexter till video](http://help.adobe.com/en_US/scene7/using/WS98ca2e6790647c06-6f6f53e137b959f094-8000.html).
...
* Övervakning av funktionen för ogiltig CDN-cache - När du har valt en mall för CDN-validering (se [Allmänna inställningar](http://help.adobe.com/en_US/scene7/using/WSCCBA9D3A-06A3-4f29-AF6B-36CBB2A655F1.html)) och en **[!UICONTROL ogiltig CDN]** -begäran görs via Arkiv-menyn i SPS visas nu en indikator i användargränssnittet som ger dig en uppskattning av hur lång tid det tar att rensa cachen.
