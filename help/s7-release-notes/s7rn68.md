...
* Konvertera e-post med glömt lösenord från HTML till oformaterad text för att förhindra svartlistning.
...
* Fast: metoden aktiveras inte `selectSwatch` när den är inbäddad i `initViewer()` funktionen.
