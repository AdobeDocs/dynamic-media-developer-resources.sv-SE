---
description: Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.8 som en del av Adobe Experience Manager-lösningen i Adobe Marketing Cloud.
seo-description: Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.8 som en del av Adobe Experience Manager-lösningen i Adobe Marketing Cloud.
...
Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.8 som en del av Adobe Experience Manager-lösningen i Adobe Marketing Cloud.

## Versionsinformation om Scene7 Publishing System 6.8 (maj 2014) {#topic-4517aab837ea4d6d8204425958860e5a}

Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för [!DNL Adobe Scene7 Publishing System] 6,8-delar av Adobe Experience Manager-lösningen i [!DNL Adobe Marketing Cloud].
...
* Integrering av videorapporter i Adobe Analytics för HTML5 Video Viewer och Mixed Media Viewer.
* Händelsespårning för flera HTML5-visningsprogram på samma sida.
* Lagt `SetIndicator` till i HTML5 Zoom Viewer och HTML5 Mixed Media Viewer för att visuellt representera färgrutor på mobila enheter.
* Lagt till `getComponent` API för extern åtkomst till HTML5-visningsprogramkomponenter.
...
Se även [Referenshandbok](/help/aem-viewers-ref/t-installing-the-viewers.md)för Scene7-visningsprogram.
...
* Konvertera e-post med glömt lösenord från HTML till oformaterad text för att förhindra blocklistning.
...
* Ett varningsmeddelande har lagts till när du redigerar Adobe Analytics-konfigurationen och försöker sedan fly från konfigurationen utan att spara.
...
* Flash-plugin och Scene7 Publishing System kraschade på grund av ett stort antal mappar som inte har tillräckligt med Flash-minne.
...
* Etiketten Company visas inte helt på sidan Adobe Analytics Setup.
* Det går inte att importera metadata.

## Kända fel {#section-b2608177928b4174b080d89c938bb0d3}

* Uppdateringen av Adobe Illustrator CC (Creative Cloud) och Adobe InDesign CC från maj 2014 förväntas medföra inkompatibilitet med plugin-program som skapar Scene7 FXG. Dessa inkompatibiliteter påverkar användare av Scene7 Web-to-Print-lösningen. Om du använder Scene7 Web-to-Print ska du inte uppgradera Illustrator och InDesign till denna Creative Cloud-uppdatering. Använd istället före maj 2014-versionen. Adobe Systems räknar med att Scene7 FXG-skapandet ska bli kompatibelt med nyare versioner av Illustrator och InDesign under hösten 2014.
...
* Textavstavning tas bort i Scene7 6.9 Fall-versionen. Avstavningsordlistorna definierar hur ord kan delas upp och avstavas för att ge optimalt textflöde.
...
* Påminnelse: Metadataservern och användningen av associerade API:er har officiellt inaktiverats i den tidigare Scene7-versionen.
...
## Versionsinformation om Scene7 Image Serving Viewers 5.0.1 {#section-3fc1a827bcc84c0488229d310086ad8e}

Se [https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_rn_04_29_14.html](https://marketing.adobe.com/resources/help/en_US/s7/viewers_ref/c_rn_04_29_14.html)
...
* Fast: `selectSwatch` -metoden aktiveras inte när den är inbäddad i `initViewer()` funktionen.
...
* Fast: Ikonen för delning via sociala medier tonas inte ut med `controlbar` zoomverktyget.
...
* Stöd för `initialBitRate` modifierare för att välja bithastighet som används för den första uppspelningen på skrivbordet har lagts till.
...
* Fast: HTTPS-protokoll genererar en säkerhetsvarning på IE8 med Flash-uppspelningen.
* Fast: Videon ändrar inte korrekt storlek i helskärmsläge i Safari 5 med Flash-uppspelningen.
