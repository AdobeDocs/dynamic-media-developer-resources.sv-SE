...
description: I den senaste releaseversionen beskrivs de senaste funktionerna, förbättringarna och fixarna för Adobe Scene7 Publishing System 6.6, som ingår i Adobe Experience Manager-lösningen i Adobe Experience Cloud.
...
Den senaste versionsinformationen som beskriver de senaste funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.6-delen av Adobe Experience Cloud.
...
**Adaptiv Creative och bildbehandling**
...
* En ny universell videospelare för HTML5 som gör att du kan designa alla videokomponenter en gång - t.ex. knappar och uppspelningstimer - i HTML5 och sedan leverera bästa möjliga videouppspelningsupplevelse på flera enheter och skärmar.
