...
* Lagt till&quot;Bädda in kod&quot; för att förenkla användningen av visningsprogram.
  ...
  The [!DNL Embed Code] är tillgänglig när du öppnar [!DNL Preview: Viewer List] sidan eller [!DNL URLs] panel i [!DNL Detail View] för någon av följande tillgångstyper:
