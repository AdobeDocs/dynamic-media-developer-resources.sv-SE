...
description: '"Versionsinformation som beskriver funktioner, förbättringar och korrigeringar för Adobe Scene7 Publishing System 6.0, en del av Adobe Experience Manager lösning i Adobe Marketing Cloud."'
...
* Stöd för lokalisering av verktygstipstext har lagts till i visningsförinställningarna för Flash AS3 och HTML5.
...
* Lagt till&quot;Embed Code&quot; för att förenkla användningen av tittarna.
   ...
   Använda [!DNL Embed Code] kan du granska visningsprogramkoden för den valda resurstypen. Du kan också kopiera koden till Urklipp så att du kan klistra in den på dina webbsidor för att distribuera visningsprogrammet. Det är inte tillåtet att redigera koden i dialogrutan Bädda in kod. .

   The [!DNL Embed Code] är tillgänglig när du öppnar [!DNL Preview: Viewer List] eller [!DNL URLs] panel i [!DNL Detail View] för någon av följande tillgångstyper:
...
* Enklare åtkomst till Flash och HTML5-visningsprogrammets SDK från Adobe Developer Connection. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html). -->
...
* Kompilera dynamiskt Flash-källmaterial (FLA) till animerade GIF-filmer, inklusive avancerad bildrutehantering. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
...
* Metadatainställningarna grupperas nu i administrationsanvändargränssnittet.
   ...
   I **[!UICONTROL Setup > Application Setup]**, är metadatarelaterade inställningssidor nu grupperade i ett avsnitt på den översta nivån som kallas [!DNL Metadata]. Här finns inställningssidorna för metadatavy, metadataförinställningar, metadataschema och användardefinierade fält.
