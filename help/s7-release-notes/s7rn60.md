...
Versionsinformation som beskriver funktioner, förbättringar och korrigeringar för Adobe Scene7 Publishing System 6.0-delen av Adobe Marketing Cloud.
...
* Efter den här versionen introduceras en ny direktpubliceringsfunktion gradvis. Den här funktionen ersätter den aktuella funktionen&quot;Markera för publicering&quot;. Vissa användare kan se de nya funktionerna framför andra. SPS-dokumentation och gränssnittselement planeras att uppdateras när utrullningsperioden närmar sig slutet. Du kan planera när du får ett e-postmeddelande med mer information när utskicket börjar.

**Visare**

* Stöd för lokalisering av verktygstipstext i visningsförinställningarna för Flash AS3 och HTML5 har lagts till.
...
* Förbättrade Flash SDK. (Mer information finns i Viktigt-filen för Flash SDK med installationsprogrammet.)
...
* Utökat globaliseringsstöd för tittare, inklusive lokalisering av text och grafik. Se användarhandböckerna för SDK för Flash eller HTML5 Viewer som ingår i SDK installationsprogram.
* Lagt till interaktivitet i e-kataloger med inbäddade video- och snurvningsvisningsprogram.
* Enklare åtkomst till SDK:n för Flash- och HTML5-visningsprogram från Adobe Developer Connection. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd4272150f67705c11b002eec12fcba4dee6-8000.html). -->
...
* Integrering med Adobe CQ5: resurssynkronisering, Scene7-visningsprogram inbäddade i CQ5 och dynamisk leverans av multimedieinnehåll på CQ5-sidor via Scene7-nätverket.
...
* Malluppsättningar - Hantera enkelt publicering av olika varianter av en Scene7-grundmall direkt från Scene7 Publishing System, så att du slipper ändra URL:er i sidkoden. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eede3a113268dc80f5-8000.html).  -->
...
* Sammanställ dynamiskt Flash-material (FLA) för banners till animerade GIF-filmer, inklusive avancerad bildrutehantering. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSd968ca97bf00cf72-5eedd3a113268dc80f4-8000.html).  -->
* Ändra dynamiskt förvrängningar som skapats med Adobe Illustrator i Scene7 Web till arbetsflödet Print online. <!-- [More information](http://help.adobe.com/en_US/scene7/using/WSef8d5860223939e2-d19776312a7267a200-8000.html#WSd968ca97bf00cf72-5eedd3a113268dc80f5-8000). -->
...
* Import av metadata kan hantera XMP-egenskaper
  ...
  Metadataimporten utökas för att hantera XMP-egenskaper, som definieras i metadatascheman.
