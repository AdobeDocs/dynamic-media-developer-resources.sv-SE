---
description: Den senaste versionsinformationen som beskriver de nya funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.10 som ingår i Adobe Experience Manager-lösningen i Adobe Marketing Cloud.
seo-description: Den senaste versionsinformationen som beskriver de nya funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.10 som ingår i Adobe Experience Manager-lösningen i Adobe Marketing Cloud.
...
Den senaste versionsinformationen som beskriver de nya funktionerna, förbättringarna och korrigeringarna för Adobe Scene7 Publishing System 6.10 som ingår i Adobe Experience Manager-lösningen i Adobe Marketing Cloud.
...
* **Söktyp** - Möjlighet att lägga till företagsegenskap för att tillåta standard för personlig söktyp **[!UICONTROL Innehåller]**.

   I **[!UICONTROL Inställningar]** > **[!UICONTROL Personlig inställningsgrupp]** > **[!UICONTROL Webbläsarrubrik]** > **[!UICONTROL Grundläggande sökningstyp]** - **[!UICONTROL Innehåller]**.
...
I **[!UICONTROL Programinställningar]** > **[!UICONTROL Allmän inställningsgrupp]** > **[!UICONTROL Andra inställningar, till Programgrupp]** > **[!UICONTROL Standardtyp för grundläggande sökning för nya användare]** .
...
* **Nya inställningar har lagts till i färdiga HTML5 Spin Set Viewers** - I **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewers]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_SpinSet_dark` `Universal_HTML5_SpinSet_light`[!DNL Configure Viewer] eller¥ har följande tillägg gjorts på varje visares respektive¥-sida:
...
* **Nya inställningar har lagts till i körklara HTML5 eCatalog-visningsprogram** - I **[!UICONTROL Inställningar]** > **[!UICONTROL Programinställningar]** > **[!UICONTROL Visningsförinställningar]** > `Universal_HTML5_eCatalog` eller `Universal_HTML5_eCatalog_Adv`, har följande tillägg gjorts på varje visares respektive [!DNL Configure Viewer] sida:
...
* **Nya inställningar har lagts till i färdiga HTML5-visningsprogram för blandade medieuppsättningar** - I **[!UICONTROL Inställningar]** > **[!UICONTROL Programinställningar]** > **[!UICONTROL Visningsförinställningar]** > `Universal_HTML5_MixedMedia_dark` eller `Universal_HTML5_MixedMedia_light`, har följande tillägg gjorts på varje visares respektive [!DNL Configure Viewer] sida:
...
* PSD-huvudfilen loggades som publicerad flera gånger per Image Server.
...
* Implementerat konfigurationsanvändargränssnitt för att skapa och uppdatera metadatafält av taggtyp. Stöd för **[!UICONTROL metadatafälttyperna]** i `fieldType` parametern omfattar `SingleFixedTag` och `BooleanTag` endast.
...
* Ett fel uppstod när du lade till ett användardefinierat fält ( **[!UICONTROL Inställningar]** > **Metadata** > **Användardefinierat fält**) av typen `Boolean`och ett värde på `true`och sedan sparade det.
