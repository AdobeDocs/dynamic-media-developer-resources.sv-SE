...
description: Den senaste versionsinformationen som beskriver nya funktioner, förbättringar och korrigeringar för Adobe Scene7 Publishing System 6.10, en del av Adobe Experience Manager-lösningen i Adobe Experience Cloud.
...
* **Nya inställningar har lagts till i användningsklara visningsprogram för HTML5-snitts uppsättningar** - I **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewers]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_SpinSet_dark` eller `Universal_HTML5_SpinSet_light` har följande tillägg gjorts på varje visares respektive [!DNL Configure Viewer] -sida:
...
* **Nya inställningar har lagts till i användningsklara HTML5 eCatalog-visningsprogram** - I **[!UICONTROL Setup]** > **[!UICONTROL Application Setup]** > **[!UICONTROL Viewer Presets]** > `Universal_HTML5_eCatalog` eller `Universal_HTML5_eCatalog_Adv` har följande tillägg gjorts på varje visares respektive [!DNL Configure Viewer]-sida:
...
* Katalogservern kan synkroniseras igen i IPS Classic Publish-valideringen - borttagen.
...
* Publish-inställningarna visade inte färgprofiler från Scene7 Shared Assets-företaget.
...
* Felaktigt format `clientAddressFilter` orsakade ett undantag från katalogservern när Publish-inställningarna för säker testbildservering användes.
...
* Tillagd Image Serving Publish-typalternativ.
...
* **Flash Viewers End-of-Life Notice** *Från och med den 31 januari 2017 upphörde Adobe Scene7 (nu Dynamic Media Classic) officiellt med stöd för visningsprogramplattformen för Flash.*
