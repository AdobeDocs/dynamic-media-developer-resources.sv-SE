...
description: '"Den senaste versionsinformationen som beskriver de nya funktionerna, förbättringarna och fixarna för Adobe Scene7 Publishing System 6.10, en del av Adobe Experience Manager-lösningen i Adobe Marketing Cloud."'
...
<table id="table_023203E3CC484F59A350C3C333EF817F"> 
 ...
 <tbody> 
  <tr> 
   ...
   <td colname="col2"> <p>Här kan du konfigurera vilken typ av zoomanimering som ska användas. Klicka på <span class="uicontrol"> Viewer Features </span> i den vänstra listen för att komma åt följande <span class="uicontrol"> Zoomläge </span>-alternativ i listrutan: </p> <p> 
...
Se även [Referenshandbok för visningsprogram](https://experienceleague.adobe.com/docs/dynamic-media-developer-resources/library/home.html).
...
* **Flash Viewers End-of-Life** *NoticeFrån och med den 31 januari 2017 upphörde Adobe Scene7 (nu Dynamic Media Classic) officiellt med stöd för visningsprogramplattformen Flash.*
