...
Textsträng. Valfritt. Om det anges måste det vara en giltig relativ eller absolut filsökväg. Om det är tomt `vignette::Modifier` måste det innehålla `vignette=` kommandot.
