...
Felsvarsbild. Bildåtergivning returnerar vanligtvis en felstatus med ett textmeddelande när ett fel inträffar. `attribute::ErrorImage` tillåter konfiguration av en bild som returneras om ett fel uppstår.
...
Ärvs från `default::ErrorImage` om det inte har definierats. Om den är definierad men tom inaktiveras felbildens beteende, även om `default::ErrorImage` är definierad och HTTP-felstatusen returneras.
