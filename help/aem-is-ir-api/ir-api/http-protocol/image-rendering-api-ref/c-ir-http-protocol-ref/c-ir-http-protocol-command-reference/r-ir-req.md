...
Returnerar markerade egenskaper för den vinjettfil eller katalogpost som anges i URL-sökvägen. Se [Egenskaper](../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-response-data/c-ir-properties.md#concept-e99f1a373eae4af9b41842ca0088ad3a) för en beskrivning av MIME-typen för svarssyntax och MIME-typ. Andra kommandon i begäran ignoreras. Följande egenskaper returneras:
...
<table id="table_A30296D29B5D43F1B5383A887252C6B4"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Sträng </p> </td> 
   <td colname="col3"> <p> <span class="codeph"> attribute::Modifier </span> eller empty if not a catalog entry. </p> </td> 
  </tr> 
  <tr> 
...
<table id="table_F3ECF0584F6247A2A75C1CAFE1C57A4E"> 
 ...
 <tbody> 
  ...
  <tr> 
   ...
   <td> <p> JPEG-kvalitet och chroma-flagga (se <span class="codeph"> qlt= <a href="../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-qlt.md#reference-27b91c226eb241d0a14a29af3b3afdbd" type="reference" format="dita" scope="local"> </a> </span>) </p> </td> 
  </tr> 
  <tr> 
...
Returnerar innehållet i `vignette::UserData`. Servern ersätter alla förekomster av `'??'` in `vignette::UserData` med radavslutningar ( `<cr><lf>`). Svaret formateras som textdata med MIME-svarstypen inställd på &lt;text/plain>.

Om objektet som anges i URL-sökvägen inte tolkas som en giltig post för vinjetteringsschemat, eller om `vignette::UserData` är tomt, innehåller svaret bara en radavslutning ( `CR/LF`).
