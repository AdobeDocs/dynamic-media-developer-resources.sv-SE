...
Om *`thickness`* anges återges en skugga om vinjetteringsobjektet definierar en lämplig ljusvektor. Ange 0 *`thickness`* för att inaktivera skuggåtergivning.
...
`catalog::Size` om det dekala materialet är baserat på en katalogpost, i annat fall `size=0,0,0`. Dekalstorleken beräknas från `res=` om *`wid`* och *`hei`* inte anges eller har angetts till 0. Ingen skugga återges om den inte *`thickness`* är angiven eller inställd på 0.
