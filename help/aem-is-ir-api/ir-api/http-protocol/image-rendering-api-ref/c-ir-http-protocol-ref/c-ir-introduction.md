...
Endast de allmänt tillgängliga aspekterna av protokollet beskrivs. Servern kan stödja ytterligare kommandon som är reserverade för användning av klientprogramvaran Scene7.
...
** *`vignette`* ** En bild som har förberetts i Scene7 Image Authoring för användning med bildåtergivning.
