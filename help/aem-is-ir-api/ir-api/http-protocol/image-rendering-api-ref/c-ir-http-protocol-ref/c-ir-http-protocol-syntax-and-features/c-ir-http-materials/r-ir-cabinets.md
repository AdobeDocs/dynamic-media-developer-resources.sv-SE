...
[!DNL vnc] filerna kan innehålla en upprepningsbar kornstextur av trä, eller så kan texturen ges externt via ett andra argument till `src=`. Vissa [!DNL vnc] filer kan användas för att färgsätta eller texturera valda områden i skåpsrutor (används vanligtvis för att laminera skåpsstilar).
...
<table id="table_0B16200886FE4DFEBB1E4BE8FBA67EE4"> 
 ...
 <tbody> 
  ...
  <tr> 
   <td colname="col1"> <p> <a href="../../../../../../ir-api/http-protocol/image-rendering-api-ref/c-ir-http-protocol-ref/c-ir-http-protocol-command-reference/r-ir-flags.md#reference-3a4844f0f21346d79e6508aaad9a9ac9" type="reference" format="dita" scope="local"> <span class="codeph"> flagga= </span></a> </p> </td> 
