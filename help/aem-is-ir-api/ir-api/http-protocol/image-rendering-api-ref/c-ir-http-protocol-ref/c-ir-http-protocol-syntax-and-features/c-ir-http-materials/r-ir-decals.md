...
En dekal kan användas för varje platt, flödeslinje, skiss, plan eller väggobjekt (om inte flaggan Ingen textur är inställd). Decals tillämpas på objektet genom att dekalens `anchor=` justeras mot vinjettobjektets dekaloripunkt. Positionen kan justeras ytterligare med `pos=`.
