...
En dekal kan användas för varje platt, flödeslinje, skiss, plan eller väggobjekt (om inte flaggan Ingen textur är inställd). Decaler används på objektet genom att de exakta värdena justeras `anchor=` mot vinjettobjektets exakta utgångspunkt. Positionen kan justeras ytterligare med `pos=`.
