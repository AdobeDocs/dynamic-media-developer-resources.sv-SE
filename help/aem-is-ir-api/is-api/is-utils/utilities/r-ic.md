...
<table id="table_02011C7C076745A8BF4378B22C48C8A3"> 
 <tbody> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Använd JPEG-kodning. Ignoreras om <span class="codeph"> sourceFile <span class="varname"></span> </span> innehåller alfavärden. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Utskriftsupplösning (dpi) för <span class="codeph"> <span class="varname"> destFile </span> </span>; om inget anges, kopieras <span class="codeph"> srcFile-utskriftsupplösningen </span> till <span class="codeph"> <span class="varname"> destFile </span> </span>. </p> </td> 
  </tr> 
  <tr> 
   <td colname="col1"> <p> <span class="codeph"> -autocrop &lt; <span class="varname"> corner </span>&gt; &lt; <span class="varname"> mode </span>&gt; &lt; <span class="varname"> olerans </span>&gt; &lt; <span class="varname"> infoFile </span>&gt; </span> </p> </td> 
...
<p><i><b>corner</b></i> - ul| ur| alla| lr </p>
   ...
   <p><i><b>infoFile</b></i> - Sökväg till och namn på XML-utdatafilen som beskärningsinfo-data ska skrivas till.</p>
...
<p>  
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Nedsampla med Photoshop-stil 8x8 bikubisk-skarp filter. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Tillåt att en befintlig <span class="codeph"> målfil skrivs över <span class="varname"> </span> </span>. Som standard läggs ett numeriskt suffix till i filnamnet för att förhindra att filen skrivs över. </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Loggfilens sökväg och namn (standard är <span class="codeph"> stdout </span>). </p> </td> 
  </tr> 
  <tr> 
  ...
  <tr> 
   ...
   <td colname="col2"> <p>Minnesanvändningsgräns. Standardvärdet är 25 % av det fysiska minnet. Om varken <span class="codeph"> maxmem </span> eller <span class="codeph"> maxmempercent </span> anges explicit använder maxmempercent-standardvärdet. </p> </td> 
  </tr> 
  <tr> 
...
Konvertera alla bilder i *`srcFolder`* till JPEG-kodade pyramidbilder i TIFF-format och montera i *`destFolder`*:
