...
description: Ange attribut för FXG-rotelementet.
...
Ange attribut för FXG-rotelementet.

` setAttr.rootElement={ *[!DNL attributeName]*= *[!DNL attributeValue]*%26 *[!DNL attributeName]*= *[!DNL attributeValue]*}`

Det här kommandot kan ändra attributen för rotelementet.

## Exempel {#section-2758a6e316c34b99b13b02147e5973bb}

Om du har följande rotelement:
