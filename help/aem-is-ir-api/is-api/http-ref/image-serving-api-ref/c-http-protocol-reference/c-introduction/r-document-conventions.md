...
<table id="simpletable_8C9DB0DA5F2B4C068794415602B768CB"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> attribut: </span> refererar till ett bildkatalogsattribut. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> katalog::Item </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> katalog: </span> refererar till ett datafält för bildkatalog. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> icc::Item </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> icc: </span> hänvisar till ett fält i ICC-färgprofilsmappningen. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> font::Item </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> teckensnitt: </span> hänvisar till ett fält i teckensnittskartan. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> makro: Objekt </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> makro: </span> refererar till ett fält i makrodefinitionstabellen. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> linjaluppsättning::Item </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> linjaluppsättning: </span> refererar till ett element i en regeluppsättning för förbehandling av URL. </p> </td> 
 </tr> 
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> default::Item </span> </p> </td> 
  <td class="stentry"> <p>Ett namn med prefix <span class="codeph"> standard: </span> refererar till ett attribut för standardbildkatalogen. </p> </td> 
 </tr> 
 <tr class="strow"> 
 ...
 <tr class="strow"> 
  <td class="stentry"> <p> <span class="codeph"> *[ <span class="varname"> valfri </span>] </span> </p> </td> 
  <td class="stentry"> <p>The <span class="varname"> valfri </span> syntaxelement kan upprepas en eller flera gånger. </p> </td> 
 </tr> 
 <tr class="strow"> 
