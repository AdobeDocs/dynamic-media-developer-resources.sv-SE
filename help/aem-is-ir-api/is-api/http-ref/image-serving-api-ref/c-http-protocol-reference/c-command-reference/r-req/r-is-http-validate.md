...
Tolkar begärandesträngen som om den `req=img` hade angetts, men utan att ersätta variabler och utvärdera refererade objekt (bilder, ICC-profiler, teckensnitt osv.). Standardfelsvaret returneras om tolkningen misslyckas, annars returneras följande egenskap:
