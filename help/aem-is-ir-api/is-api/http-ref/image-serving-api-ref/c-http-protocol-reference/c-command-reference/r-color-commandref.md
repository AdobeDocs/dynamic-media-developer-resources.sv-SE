...
Om det finns bild- och textlager fyller `color=` genomskinliga och halvgenomskinliga områden i markeringsramen för lagret med den angivna färgen* före* `rotate=` och `extend=`.
