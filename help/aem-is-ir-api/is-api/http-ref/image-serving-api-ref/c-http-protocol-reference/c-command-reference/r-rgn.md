...
>[!NOTE]
>
>`rgn=` definierar bara en avkastning utan att beskära bilden. När `wid=` och/eller `hei=` större än storlek används kan ytterligare data från den sammansatta bilden visas i den slutliga svarsbilden.
