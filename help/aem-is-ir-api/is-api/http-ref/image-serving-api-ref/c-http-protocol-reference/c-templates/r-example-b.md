...
<table id="simpletable_37BA3B2A75A9468C9ADEBBC034BADAE7"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p><span class="codeph"> $text=layer+1+text+goes+here&amp; layer=0&amp;size=800,0&amp;extend=0,100,200,100&amp;src=$object$&amp;originN=.5,0&amp; layer=1&amp;text=rtf..$text$..rtf-encoding&amp;rotate=-9 0&amp;originN=.5,0&amp;posN=0.5,0</span> </p></td> 
 </tr> 
</table>

Bilden placeras i lager 0 och höjdvärdet `size=` är 0. Den här inställningen gör att den faktiska höjden bestäms av bildens höjd efter att den skalats till 800 pixlar bred.
...
![Exempel på B-bild](assets/exampleb.png)
