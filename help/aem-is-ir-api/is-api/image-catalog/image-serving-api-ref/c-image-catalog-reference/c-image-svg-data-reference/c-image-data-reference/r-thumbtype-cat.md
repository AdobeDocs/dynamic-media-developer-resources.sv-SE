...
<table id="simpletable_874E4190A1DC4FB0AE1B2E3734746527"> 
 ...
 <tr class="strow"> 
  ...
  <td class="stentry"> <p>Beskär bilden baserat på upplösning. Bilden skalas efter förhållandet mellan <span class="codeph"> katalog::ThumbRes</span> och <span class="codeph"> katalog::Resolution</span>. Om den resulterande bilden är större än miniatyrbilden beskärs den så att den passar, och om den skalförändrade bilden är mindre än miniatyrbilden fylls det återstående området med <span class="codeph"> -attributet::ThumbBkgColor</span>. <span class="codeph"> attribute::ThumbHorizAlign</span> and <span class="codeph"> attribute::ThumbVertAlign</span> används för att bestämma positionen för beskärningsrektangeln i en större bild eller position för en mindre bild i miniatyrbilden. </p></td> 
 </tr> 
</table>
