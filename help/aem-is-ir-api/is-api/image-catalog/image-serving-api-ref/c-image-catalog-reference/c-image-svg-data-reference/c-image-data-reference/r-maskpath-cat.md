...
Servern använder de regler för sökvägsupplösning som beskrivs i [Hantera Source-data](/help/aem-is-ir-api/is-api/image-serving-api-ref/c-configuration-and-administration/c-configuration-and-administration.md) för att hitta datafilen.
...
`catalog::MaskPath` åsidosätter alfakanalen i huvudbilden ( `catalog::Path`), om den finns, och om alfakanalen inte är associerad (d.v.s. inte förmultiplicerad). Om bildens alfa är förmultiplicerat ignoreras `catalog::MaskPath` och alfakanalen används alltid.
