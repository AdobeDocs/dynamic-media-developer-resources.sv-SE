...
Resurstypen avgör vilken typ av svar som ska genereras för `req=set` begäranden. Om inget värde anges avgör reglerna för automatisk identifiering `req=set` svarstypen.
