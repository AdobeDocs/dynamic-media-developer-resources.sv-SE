---
description: Överföringsinställning för att bearbeta ZIP- och TAR-filer som huvudresurser (ingen) eller för att extrahera och överföra deras innehåll (UnCompress).
seo-description: Överföringsinställning för att bearbeta ZIP- och TAR-filer som huvudresurser (ingen) eller för att extrahera och överföra deras innehåll (UnCompress).
...
Överföringsinställning för att bearbeta ZIP- och TAR-filer som huvudresurser (ingen) eller för att extrahera och överföra deras innehåll (UnCompress).
  ...
  <tr> 
   ...
   <td colname="col3"> <p>Kontrollerar arkiveringsfilbearbetning för ZIP och TAR. Tillhandahåller två alternativ: 
     <ul id="ul_F34E2F3B9B74450CA7E76BD9FD7137C2">
      <li id="li_E982468ED814446593B0C0A3F3D729FB"><span class="codeph"> Ingen:</span> Bearbeta som huvudresurser. </li>
