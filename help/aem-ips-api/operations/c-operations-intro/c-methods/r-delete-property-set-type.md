...
I det här kodexemplet används typens handtag som ett fält i den `deletePropertySetTypeParam` som skickas till IPS Web services-servern för att ta bort egenskapsuppsättningstypen.
