...
|---|---|---|---|
| ` *`companyHandle`*` | `xsd:string` | Nej | Referensen till företaget som äger egenskapsuppsättningstypen. Om `companyHandle` inte skickas och anroparen är en `IpsAdmin`egenskap skapas en global egenskapsuppsättningstyp. |
...
I det här kodexemplet skapas en egenskapsuppsättning med ett namn och en typ som anges av `PropertySet Types` -konstanten. Referensen till företaget som äger egenskapsuppsättningstypen. Om companyHandle inte skickas och anroparen är en IpsAdmin skapas en global egenskapsuppsättningstyp.
